...
for i, msg in enumerate(msgs[::-1]):
    for response_part in msg:
        if type(response_part) is tuple:
            ...
            x2,y2=auto.locateCenterOnScreen(r"images\patientID.png",confidence=0.9)
            auto.moveTo(x2,y2,1)
            auto.click()
            time.sleep(1)
            auto.write(name)
            x3,y3=auto.locateCenterOnScreen(r"images\patientName.png",confidence=0.9)
            auto.moveTo(x3,y3,1)
            auto.click()
            time.sleep(1)
            auto.write(age)
            x4,y4=auto.locateCenterOnScreen(r"immages\patientEmail.png",confidence=0.9)
            auto.moveTo(x4,y4,1)
            auto.click()
            time.sleep(1)
            auto.write(ph_no)
            x5,y5=auto.locateCenterOnScreen(r"images\Ph_No.png",confidence=0.9)
            auto.moveTo(x5,y5,1)
            auto.click()
            time.sleep(1)
            auto.write(address)
            x6,y6=auto.locateCenterOnScreen(r"images\BloodGrp.png",confidence=0.9)
            auto.moveTo(x6,y6,1)
            auto.click()
            time.sleep(1)
            auto.write(blood_grp)
            x7,y7=auto.locateCenterOnScreen(r"images\add.png",confidence=0.9)
            auto.moveTo(x7,y7,1)
            auto.click()
